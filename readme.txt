...
Donate link: https://wordpress.org/plugins/advanced-post-duplicator
Tags: duplicate, posts, pages, copy, clone, multisite, bulk, elementor, woocommerce
...
Duplicate posts, pages, and custom post types with customizable settings including post status, date, and offset options. Perfect for WordPress Multisite networks with cross-site duplication support.
...
= 1.0.0 =
Initial release of Advanced Post Duplicator.
